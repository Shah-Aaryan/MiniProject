...
const Quiz = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const unansweredQuestions = Object.keys(formData).filter(key => !formData[key]);
    ...
    const formattedData = {
      ...
      question10: parseInt(formData.question10),
      question11: parseInt(formData.question11),
      question12: parseInt(formData.question12),
      question13: parseInt(formData.question13),
      question14: parseInt(formData.question14),
      question15: parseInt(formData.question15),
      question16: parseInt(formData.question16),
      question17: parseInt(formData.question17),
      question18: parseInt(formData.question18),
      question19: parseInt(formData.question19),
    };
    
    console.log('Formatted data:', formattedData);
    
    // Show loading state
    alert('Submitting quiz... Please wait.');
